...
* p. 179, Example 10.5 global optimum should actually be at -pi/2, rather than -1.5. Future releases will use x^2 < 1 so optimum will be at -1. (thanks Steven Pauly)
